  ...
  return (
    <>
      ...
      <button
        ...
        className="group mb-4 flex w-full items-center justify-center gap-3 border border-hairline bg-canvas px-5 py-3.5 font-body text-[14px] font-medium text-ink transition-colors hover:border-accent disabled:cursor-not-allowed disabled:opacity-60"
      >
...
export function LoginButtons() {
  return (
    <Suspense fallback={<div className="mb-4 h-[52px] border border-hairline bg-canvas" />}>
      <LoginButtonsInner />
    </Suspense>
  );
}
