...
Open the Vaultwarden module page at [flareo.dev/modules/vaultwarden](https://flareo.dev/modules/vaultwarden). Scroll to the deploy panel. Copy the pinned digest — it looks like:
...
Paste that reference into the box at [flareo.dev/verify](https://flareo.dev/verify) and hit Verify. You should see three green checks:
