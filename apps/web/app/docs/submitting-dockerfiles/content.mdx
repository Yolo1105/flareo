...
<aside className="mb-6 border border-warn/50 bg-warn/[0.04] p-4">
  <div className="mb-1.5 font-mono text-[10.5px] font-medium tracking-[0.14em] text-warn">
    HISTORICAL
  </div>
  <p className="m-0 font-body text-[13.5px] leading-[1.65] text-ink-softer">
    Dockerfile submissions are closed. This page documents how the retired
    build pipeline expected Dockerfiles to be written — network-free,
    digest-pinned, Trivy-clean. See the{" "}
    <a href="/docs/threat-model" className="text-accent hover:text-accent-hot">
      threat model
    </a>{" "}
    for why the path was retired, or{" "}
    <a href="/verify" className="text-accent hover:text-accent-hot">
...
- [GitHub Issues](https://github.com/Yolo1105/flareo/issues) — reply within 1 business day
- GitHub issues: [github.com/Yolo1105/flareo/issues](https://github.com/Yolo1105/flareo/issues), `module-submission` label
