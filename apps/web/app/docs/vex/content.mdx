...
```json
{
  ...
  "@id": "https://flareo.app/api/v1/modules/vaultwarden/vex",
...
**Trivy:**
```sh
trivy image --vex https://flareo.app/api/v1/modules/vaultwarden/vex \
  public.ecr.aws/flareo/vaultwarden@sha256:...
```

**Grype:**
```sh
grype --vex https://flareo.app/api/v1/modules/vaultwarden/vex \
  public.ecr.aws/flareo/vaultwarden@sha256:...
```
