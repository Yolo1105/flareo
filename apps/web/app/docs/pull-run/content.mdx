...
If you want the current pinned digest for a module, it's on the module page at [flareo.dev/modules/vaultwarden](https://flareo.dev/modules/vaultwarden), or via API:
...
**Reverse proxy.** The [Caddy module](https://flareo.dev/modules/caddy) is designed to sit in front of everything else. A minimal Caddyfile for Vaultwarden:
