      ...
      <main className="container">
          ...
          <div className="container">
            <div className="hero-content">
              ...
              <p className="hero-description">
                Plugin Hub 是一个前后端通用的插件分发与部署平台，让你轻松找到、部署和定制适合你需求的插件服务。
              </p>
        ...
        <section className="how-to-use-section my-5 py-5 bg-light">
          <div className="text-center mb-5">
            <h2 className="section-title">如何使用 Plugin Hub</h2>
            <p className="mt-2" style={{ color: "var(--neutral-600)" }}>
              Plugin Hub 让您轻松找到、部署和集成所需的插件服务，只需简单三步即可开始使用
            </p>
          </div>
          ...
          <div className="testimonial-grid">
            <div className="testimonial-card">
              <div className="testimonial-content">
                "Plugin Hub 彻底改变了我们的工作流程。我们现在可以轻松找到并部署所需的插件，大大提高了开发效率。"
              </div>
            ...
            <div className="testimonial-card">
              <div className="testimonial-content">
                "作为一名插件开发者，Plugin Hub
                为我提供了一个展示和销售作品的完美平台。收益模式非常透明，社区反馈也很有价值。"
              </div>
              <div className="testimonial-author">
                <Image
            ...
            <div className="testimonial-card">
              <div className="testimonial-content">
                "我们公司使用 Plugin Hub
                定制了几个专用插件，整个过程非常顺畅。众包系统让我们快速找到了合适的开发者，质量超出预期。"
              </div>
              <div className="testimonial-author">
                <Image
        ...
        <section className="cta-section">
          ...
          <p className="cta-description">
            无论你是寻找插件解决方案的用户，还是希望分享创意的开发者，Plugin Hub 都能满足你的需求。
          </p>
        ...
        <section className="developer-section">
          <div className="developer-content">
            <div className="developer-text">
              <h2 className="developer-title">成为 Plugin Hub 开发者</h2>
