        ...
        <div>
          ...
          <section className="plugin-header">
            ...
            <section className="related-plugins">
              <h2 className="related-title">相关插件</h2>
              ...
              <div className="related-grid">
                <div className="card plugin-card">
                  ...
                  <div className="plugin-card-body">
                    <h3 className="plugin-card-title">API 文档生成器</h3>
                    <p className="plugin-card-description">自动从 API 定义生成交互式文档，支持 OpenAPI 规范。</p>
                ...
                <div className="card plugin-card">
                  ...
                  <div className="plugin-card-body">
                    ...
                    <p className="plugin-card-description">实时处理和分析日志数据，自动检测异常并发送警报。</p>
                    <div className="plugin-card-meta">
