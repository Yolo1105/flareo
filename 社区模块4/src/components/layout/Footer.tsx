    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-sm font-semibold text-gray-900 tracking-wider uppercase">关于我们</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 tracking-wider uppercase">资源</h3>
            <ul className="mt-4 space-y-4">
              <li>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 tracking-wider uppercase">社区</h3>
            <ul className="mt-4 space-y-4">
              <li>
              ...
              <li>
                <Link href="/crowdsourcing" className="text-base text-gray-500 hover:text-gray-900">
                  众包墙
                </Link>
              </li>
              <li>
                <Link href="/contest" className="text-base text-gray-500 hover:text-gray-900">
                  极客演武场
                </Link>
              </li>
            </ul>
